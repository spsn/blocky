...
//TODO import org.newdawn.slick.opengl.renderer.SGL;
//TODO import org.newdawn.slick.opengl.renderer.Renderer;
...
//TODO	protected static SGL GL = Renderer.get();
    ...
    public static void bindNone() {
    	lastBind = null;
//TODO    	GL.glDisable(SGL.GL_TEXTURE_2D);
    ...
    public void bind() {
    	if (lastBind != this) {
    		lastBind = this;
//TODO    		GL.glEnable(SGL.GL_TEXTURE_2D);
    		GLES20.glEnable(GLES20.GL_TEXTURE_2D);
//TODO    	    GL.glBindTexture(target, textureID);
...
//TODO    	GL.glDeleteTextures(texBuf);
    	GLES20.glDeleteTextures(texBuf);
    ...
    public byte[] getTextureData() {
    	...
    	bind();
//TODO    	GL.glGetTexImage(SGL.GL_TEXTURE_2D, 0, hasAlpha() ? SGL.GL_RGBA : SGL.GL_RGB, SGL.GL_UNSIGNED_BYTE, buffer);
