...
public class InternalTextureLoader {
    ...
    private int dstPixelFormat = GLES20.GL_RGBA; //TODO - 8
    ...
    public void set16BitMode() {
    	dstPixelFormat = GLES20.GL_RGB565; //TODO - 16
    }
    ...
    { 
        ...
        GLES20.glGetInteger(GLES20.GL_MAX_TEXTURE_SIZE, temp);
        int max = temp.get(0);
        if ((texWidth > max) || (texHeight > max)) {
        	throw new IOException("Attempt to allocate a texture to big for the current hardware");
        }
        
        int srcPixelFormat = hasAlpha ? GLES20.GL_RGBA : GLES20.GL_RGB;
    ...
    public Texture createTexture(final int width, final int height) throws IOException {
    	return createTexture(width, height, GLES20.GL_NEAREST);
    }
